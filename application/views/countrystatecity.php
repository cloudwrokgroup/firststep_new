             ...
             <div class="nav-tabs-custom">
				...
				<div class="tab-content">
				  <div class="tab-pane active" id="tab_country">
				   <div class="row">
					  <form action="" method="post" name="country_form" id="country_form">
						<div class="col-md-6">
							<label class="col-md-5 control-label">Country Name</label>
							<div class="col-md-7">
							<input type="text" class="input-sm form-control" name="country_name" id="country_name"/>
							</div>
						</div>
						<div class="col-md-6">						
					...
					<div class="row">
					  <form action="" method="post" name="state_form" id="state_form">
						<div class="col-md-6 form-group">
							<label class="col-md-5 control-label">Country Name</label>
							<div class="col-md-7">
							<select class="input-sm form-control country" name="state_country_name" id="state_country_name">
						...
						<div class="col-md-6 form-group">
							...
							<div class="col-md-7">
							<input type="text" class="input-sm form-control" name="state_name" id="state_name"/>
							</div>
						</div>
						<div class="col-md-6 form-group">						
							<div class="pull-right">
							<input type="submit" class="btn btn-xs btn-primary" name="state_submit" id="state_submit"/>
							<input type="reset" class="btn btn-xs btn-warning" name="state_reset" id="state_reset"/>
							</div>
						</div>
					  </form>
				   </div>
				  ...
				  <div class="row">
					  <form action="" method="post" name="city_form" id="city_form">
						<div class="col-md-6 form-group">
							<label class="col-md-5 control-label">Country Name</label>
							<div class="col-md-7">
							<select class="input-sm form-control country" name="city_country_name" id="city_country_name" onchange="load_state('city_country_name')">
								<option value="">-Select-</option>
							</select>
							</div>
						</div>
						<div class="col-md-6 form-group">
							<label class="col-md-5 control-label">State Name</label>
							<div class="col-md-7">						
							<select class="input-sm form-control state" name="city_state_name" id="city_state_name">
							<option value="">-Select-</option>
							</select>
							</div>
						</div>
						<div class="col-md-6 form-group">
							...
							<input type="text" class="input-sm form-control" name="city_name" id="city_name"/>
							</div>
						</div>
						<div class="col-md-6 form-group">						
							<div class="pull-right">
							<input type="submit" class="btn btn-xs btn-primary" name="city_submit" id="city_submit"/>
							<input type="reset" class="btn btn-xs btn-warning" name="city_reset" id="city_reset"/>
							</div>
						</div>
					  </form>
				   </div>
