...
<div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" id="admin_user_form" name="admin_user_form" action="" method="post">
              <div class="box-body">
               <div class="form-group col-md-6">
                  <label for="User_email" class="col-md-5">User Email</label>
                  <div class="col-md-6">
                  <input type="text" class=" input-sm form-control" name="user_email" id="user_email" placeholder="Please Enter User E-mail">
                  </div>                  
                </div>
                <div class="form-group col-md-6">
                  <label for="User_name" class="col-md-5">User name</label>
                  <div class="col-md-6">
                  <input type="text" class=" input-sm form-control" name="user_name" id="user_name" placeholder="Please Enter User Name">
                  </div>                  
                </div>
                <div class="form-group col-md-6">
                  <label for="department_name" class="col-md-5">Department Name</label>
                  <div class="col-md-6">
                  <select class="input-sm form-control" name="department_name" id="department_name">
