            ...
            <!-- form start -->
              ...
              <div class="col-md-12 form-group">
                <div class="col-md-6 ">
                  ...
                  <div class="col-md-7">
                    <input type="text" class="input-sm form-control" name="profits" id="profits"/>
              ...
              <div class="pull-right">
                  <input type="submit" class="btn btn-xs btn-primary" name="profits_submit" id="profits_submit" />
                    <input type="reset" class="btn btn-xs btn-warning" name="profits_reset" id="profits_reset" />
              </div>
