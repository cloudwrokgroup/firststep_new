				...
				<div class="box-body">
					<div class="col-md-12 form-group">
						...
						<div class="col-md-6">
							...
							<div class="col-md-7">
								<select class="input-sm form-control" name="product"
									id="product">
					...
					<div class="col-md-12 form-group">
						<div class="col-md-6 ">
							...
							<div class="col-md-7">
								<select class="input-sm form-control" name="vehicle"
									id="vehicle">
				...
				<div class="box-footer">
					<div class="pull-right">
						<input type="submit" class="btn btn-xs btn-primary"
							name="commodity_submit" id="commodity_submit" /> <input
							type="reset" class="btn btn-xs btn-warning"
							name="commodity_reset" id="commodity_reset" />
					</div>
