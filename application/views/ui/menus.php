            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo portal_url()?>logout" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo portal_url()?>department"><i class="fa fa-circle-o"></i> Department</a></li>
            <li><a href="<?php echo portal_url()?>admin"><i class="fa fa-circle-o"></i> Admin Users</a></li>
          </ul>
        </li>
      </ul>
    </section>
