					...
					<ul class="nav navbar-nav">
									...
									<ul class="menu">
										<li>
											<!-- start message --> <a href="#">
												<div class="pull-left">
													<img
														src="<?php echo asset_url()?>dist/img/user2-160x160.jpg"
										...
										<li><a href="#">
												<div class="pull-left">
													<img
														src="<?php echo asset_url()?>dist/img/user3-128x128.jpg"
														class="img-circle" alt="User Image">
												</div>
												<h4>
										...
										<li><a href="#">
												<div class="pull-left">
													<img
														src="<?php echo asset_url()?>dist/img/user4-128x128.jpg"
														class="img-circle" alt="User Image">
												</div>
												<h4>
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								src="<?php echo asset_url()?>dist/img/user2-160x160.jpg"
								class="user-image" alt="User Image"> <span class="hidden-xs"><?php  echo $this->session->userdata['logged_in']['username']?></span>
						</a>
							<ul class="dropdown-menu">
								<!-- User image -->
                  ...
                  <small></small>
								...
								<li class="user-footer">
									...
									<div class="pull-right">
										<a href="<?php echo portal_url()?>logout"
			...
			<section class="sidebar">
				...
				<div class="user-panel">
					<div class="pull-left image">
						<img src="<?php echo asset_url()?>dist/img/user2-160x160.jpg"
							class="img-circle" alt="User Image">
					</div>
